...
let NotificationController = class NotificationController {
    ...
    async create(body) {
        const dto = create_notification_dto_1.CreateNotificationSchema.parse(body);
        return this.service.create(dto);
    }
    async findAll(userId, status, limit) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], NotificationController.prototype, "markAsArchived", null);
__decorate([
