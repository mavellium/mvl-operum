...
let ProjectController = class ProjectController {
    ...
    create(body, tenantId) {
        const parsed = project_service_1.CreateProjectSchema.safeParse({ ...body, tenantId });
        if (!parsed.success)
    ...
    update(id, tenantId, body) {
        const parsed = project_service_1.UpdateProjectSchema.safeParse(body);
        if (!parsed.success)
            throw new common_1.BadRequestException(parsed.error.issues[0].message);
    ...
    getMembers(id, tenantId) {
        return this.projectService.getMembers(id, tenantId);
    }
    addMember(projectId, tenantId, body) {
        if (!body.userId)
    ...
    upsertMacroFases(projectId, tenantId, body) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], ProjectController.prototype, "listMacroFases", null);
__decorate([
    (0, common_1.Post)(':id/macro-fases'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Headers)('x-tenant-id')),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, Object]),
    __metadata("design:returntype", void 0)
], ProjectController.prototype, "upsertMacroFases", null);
