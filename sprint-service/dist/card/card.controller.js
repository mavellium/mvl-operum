...
let CardController = class CardController {
    ...
    search(q, sprintId, projectId, responsibleUserId) {
        if (!q || q.trim().length < 2)
            throw new common_1.BadRequestException('q é obrigatório (mínimo 2 caracteres)');
    ...
    update(id, body, userId) {
        const parsed = card_service_1.UpdateCardSchema.safeParse({ ...body, userId });
        if (!parsed.success)
            throw new common_1.BadRequestException(parsed.error.issues[0].message);
...
__decorate([
    (0, common_1.Get)('cards/search'),
    __param(0, (0, common_1.Query)('q')),
    __param(1, (0, common_1.Query)('sprintId')),
    __param(2, (0, common_1.Query)('projectId')),
    __param(3, (0, common_1.Query)('responsibleUserId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, String]),
    __metadata("design:returntype", void 0)
], CardController.prototype, "search", null);
__decorate([
...
__decorate([
    (0, common_1.Get)('cards/:id/movements'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], CardController.prototype, "listMovements", null);
__decorate([
